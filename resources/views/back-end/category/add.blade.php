						...
						<form action="" method="POST" role="form">
				      		...
				      		<div class="form-group">
					      		...
					      		<select name="sltCate" id="inputSltCate" class="form-control">
					      			...
					      			<?php \App\Helper::MenuMulti($data,0,$str='---| ',old('sltCate')); ?>
					      		</select>
				      		</div>
				      		<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="file" name="icon" class="form-control" id="images">

							</div>
							<button type="submit" class="btn btn-primary" value="Thêm danh mục" class="button" >Thêm Danh Mục Mới</button>
				      	</form>			      	
					</div>
				</div>
			</div>
