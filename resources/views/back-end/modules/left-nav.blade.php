<!-- left menu - menu ben  trai	 -->
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li id="danhmuc"><a href="{!!url('admin/danhmuc-tin-tuc/list')!!}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Danh mục Bài Viết</a></li>
			<li id="banner"><a href="{!!url('admin/banner/list')!!}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Banner</a></li>
			<li id="brand"><a href="{!!url('admin/brand/list')!!}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Hãng Sản Xuất</a></li>

			<li id="sanpham"><a href="{!!url('admin/sanpham/list')!!}"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg> Sản phẩm </a></li>
