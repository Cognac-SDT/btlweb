				...
				<div class="panel panel-default">					
					...
					@endif
						<form action="" method="POST" role="form" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="input-id">Hãng sản xuất</label>
								<select name="sltCate" id="inputSltCate" required class="form-control">
							...
							<div class="form-group">
								...
								<input type="text" name="txtcode" id="inputCode" class="form-control" value="{{ old('txtcode') }}"  >
							</div>
				      		<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="txtservice" id="inputTxtname" class="form-control" value="{{ old('txtname') }}"  >
							</div>
				      		<div class="form-group">
