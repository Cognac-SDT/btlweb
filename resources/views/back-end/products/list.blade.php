							...
							<div class="col-md-10"><div class="form-group">
								...
								<div class="col-md-6">
									<select name="sltCate" id="inputLoai" class="form-control">
						      			...
						      			<?php \App\Helper::MenuMulti($cat,0,$str='---| ',$loai); ?>
						      		</select>
									<script>
								...
								<div class="col-md-3">
									<input type="search" name="q" id="inputTxttk" class="form-control" value="" placeholder="Tìm sản phẩm..." required="required" title="">
								</div>
							</div>
							</div>
							<div class="col-md-2">
								@if ($loai !='all')
									<a href="{!!url('admin/sanpham/'.$loai.'/add')!!}" title=""><button type="button" class="btn btn-primary pull-right" id="click">Thêm Mới Sản Phẩm</button></a>
								@endif
							</div>
						</div> 
