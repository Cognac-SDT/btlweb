				      		...
				      		<div class="form-group">				      			
				      			<div class="row">
					      			...
					      			<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					      				Giá bán : <input type="number" name="txtprice" id="inputtxtprice" class="form-control" value="{!! $pro->unit_price !!}" required="required">
					      			</div>
									<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
										Giá bán khuyến mãi: <input type="number" name="txtproprice" id="inputtxtprice" class="form-control" value="{!! $pro->promotion_price !!}" required="required">
									</div>
