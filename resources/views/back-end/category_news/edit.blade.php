...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><small>Sửa danh mục Bài Viết</small></h1>
            </div>
        </div><!--/.row-->
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtCateTitle" id="inputTxtCateTitle" class="form-control" value="{{$cat->title}}" required="required">
                            </div>
