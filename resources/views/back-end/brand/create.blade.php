...
@section('content')
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><small>Thêm Mới Hãng Sản Xuất</small></h1>
            </div>
        </div><!--/.row-->
                                ...
                                <div class="position-center">
                                    <form action="{{route('brand.store')}}" method="post" role="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="data">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Trạng Thái</label>
                                            <select name="status" id="" class="form-control">
                                                <?php \App\Helper::optionSelect2($model->status_option,0); ?>
                                            </select>
                                        </div>
