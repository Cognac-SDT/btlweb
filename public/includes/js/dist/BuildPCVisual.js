...
var BuildPCVisual = (function () {
    ...
    var summary_tpl = `<span class="total-price-config">{{total_value}}</span> đ`;
    ...
    function showLayout(category_config) {
        ...
        $layout_container.on("click", function (e) {
            ...
            if($this_ele.hasClass('count-p')) {
                ...
                //change config
                BuildPC.updateItem(category_id, product_id, "quantity", new_quantity);
                //show new sum
            ...
            if($this_ele.hasClass('remove-item')) {
                ...
                //change config
                BuildPC.removeItem(category_id, product_id, function (category_id, product_id) {
    ...
    function showProductListToSelect(category_info) {
        ...
        var current_config = BuildPC.getConfig();
    ...
    function addProductToList(category_info, product_id) {
        ...
        if( BuildPC.isItemInCategory(category_info.id, product_id)) {
        ...
        BuildPC.emptyCategory(category_info.id);
        ...
        $.get(ACTION_URL, {
            ...
            var item_info = {
                id      : product_info.id,
                name    : product_info.proName,
                sku :   product_info.storeSKU,
                description : product_info.proSummary,
                image   : product_info.productImage.small,
                price   : product_info.price,
                url     : product_info.request_path,
            ...
            //console.log(data);
            BuildPC.selectItem(category_info, item_info, display_callback);
        });
    }
